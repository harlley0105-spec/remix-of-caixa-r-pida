...
function Vendas() {
  ...
  const fields: Field[] = [
    ...
    },
    {
      ...
      hint: "Cadastre em Produtos/serviços para aparecer aqui.",
    },
    { name: "quantity", label: "Quantidade", type: "number", required: true },
    { name: "unit_amount", label: "Valor unitário", type: "money", required: true },
    { name: "sold_on", label: "Data da venda", type: "date", required: true },
    {
      name: "payment_method",
